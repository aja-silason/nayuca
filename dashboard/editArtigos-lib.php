        ...
        <div id="page-wrapper" >
            ...
            <div class="nt-nt" style="display: flex; flex-direction: column;">
                <?php        
                 ...
                 $sqluser = "SELECT * FROM biblioteca";
                ...
                ?>
                <form action="./editLib.php" method="get">

                    <input type="text" value="<?php echo $exibiruser['id']?>" style="display: none;" name="id_lib">

                    <p style="display: flex; justify-content: space-around;"><img src="../assets/livros/capas/<?php echo $exibiruser['imglivro'] ?>" style="width: 50px; height: 50px;"> <strong>Titulo do livro:</strong> <?php echo $exibiruser['nomelivro'] ?>  <strong>Desponibilidade:</strong> <?php echo $exibiruser['desponibilidade'] ?>
                ...
                <form action="./processardeleteLib.php" method="post">
