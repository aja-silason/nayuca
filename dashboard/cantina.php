    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            ...
            <form action="./processacantina.php" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="nomeprod" id="nomeprod" class="nomeprod" placeholder="Ex: João Diogo">

                <label for="desccan">Descrição do produto<span>*</span></label>
                
                <textarea name="desccan" id="desccan" class="desccan" placeholder="Descrever o produto" maxlength="90" minlength="3" ></textarea>

                <label for="precoatual">Preço actual<span>*</span></label>
                <input type="number" name="precoatual" id="precoatual" class="precoatual" placeholder="Ex: 500">

                <label for="precoantigo">Preço antigo<span>*</span></label>
