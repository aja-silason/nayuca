        ...
        <div id="page-wrapper" >
            ...
            <div class="nt-nt" style="display: flex; flex-direction: column;">
                <?php        
                 ...
                 $sqluser = "SELECT * FROM anuncio /*WHERE idclasse like '%$filtro%' and idcurso = '1'*/";
                ...
                ?>
                <form action="./editAnuncio.php" method="get">

                    <input type="text" value="<?php echo $exibiruser['idanuncio']?>" style="display: none;" name="id_anuncio">

                    <p style="display: flex; justify-content: space-around;"><img src="../assets/anuncios/<?php echo $exibiruser['imganuncio'] ?>" style="width: 50px; height: 50px;"> | <strong>Titulo do anúncio:</strong> <?php echo $exibiruser['titulo'] ?>
                ...
                <form action="./processardeleteAnc.php" method="post">
                    <input type="text" name="elimina" value="<?php echo $exibiruser['idanuncio']?>" style="display: none;">
